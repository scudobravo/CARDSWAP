      ...
      <div>
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input 
              ...
              @input="searchPlayers"
            />
            <div v-if="filteredPlayers.length > 0 && localFilters.playerSearch" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-80 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-y-scroll focus:outline-none" style="scrollbar-width: thin; scrollbar-color: #9ca3af #f3f4f6;">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            ...
            />
            <div v-if="filteredCardSets.length > 0 && localFilters.setSearch" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-80 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-y-scroll focus:outline-none" style="scrollbar-width: thin; scrollbar-color: #9ca3af #f3f4f6;">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input 
              ...
              @input="searchTeams"
            />
            <div v-if="filteredTeams.length > 0 && localFilters.teamSearch" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-80 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-y-scroll focus:outline-none" style="scrollbar-width: thin; scrollbar-color: #9ca3af #f3f4f6;">
