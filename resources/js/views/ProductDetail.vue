          ...
          <div class="flex flex-col space-y-3 md:flex-row md:items-center md:space-x-4 md:space-y-0 flex-1 min-w-0">
            ...
            <div class="flex items-center space-x-2 flex-shrink-0">
              ...
              <router-link
                :to="{
                  name: 'seller.page',
                  params: { id: listing?.seller?.id || listing?.seller_id || vendorId }
                }"
                class="text-primary hover:text-secondary transition-colors font-futura-bold truncate"
              >
      ...
      if (response.success && response.data) {
        ...
        if (!cardModel) {
          ...
          product.value = {
            ...
            team: null,
            set_name: listing.set_name || listing.card_set?.name || null,
            year: listing.year || listing.card_set?.year || null,
            rarity: null,
