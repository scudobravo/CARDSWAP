    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm font-gill-sans">
          ...
          <li class="text-gray-500">Football</li>
        </ol>
      </nav>
      ...
      <div class="p-8 mb-8">
        <div class="flex items-center justify-center space-x-2">
          ...
          <div class="flex-shrink-0">
            <img src="/images/icons/Categorie/Football.png" alt="Football" class="w-24 md:w-48 h-auto" />
          </div>
          
          <!-- Category Info -->
          <div>
            <h1 class="text-4xl font-futura-bold text-primary">Football</h1>
          </div>
        </div>
      </div>
...
const topTrend = ref([
  ...
  },
  {
    ...
    team: "Manchester City",
    type: "Calcio",
    description: "Carta Panini del centrocampista inglese",
    price: "€28.00",
    rating: "4.6",
    image_url: null
  },
  {
    ...
    team: "Barcelona",
    type: "Calcio",
    description: "Carta Topps del talento spagnolo",
    price: "€25.00",
    rating: "4.5",
    image_url: null
  }
...
const newPlayers = ref([
  ...
  },
  {
    ...
    team: "PSG",
    type: "Calcio",
    description: "Carta Panini del centrocampista francese",
    price: "€30.00",
    rating: "4.7",
    image_url: null
  },
  {
    ...
    type: "Calcio",
    description: "Carta Topps dell'ala argentina",
    price: "€28.00",
    rating: "4.6",
    image_url: null
  }
...
const mostExpensive = ref([
  ...
  {
    id: 2,
    name: "Cristiano Ronaldo Rookie",
    team: "Sporting CP",
    type: "Calcio",
    description: "Carta rookie del 2002",
    price: "€1,800.00",
    rating: "5.0",
    image_url: null
  },
  {
    ...
    team: "Brazil",
    type: "Calcio",
    description: "Carta storica del re del calcio",
    price: "€1,200.00",
    rating: "4.9",
    image_url: null
  },
  {
    ...
    team: "Argentina",
    type: "Calcio",
    description: "Carta del campione del mondo",
    price: "€950.00",
    rating: "4.9",
    image_url: null
  }
...
const goToProductType = (productType) => {
  ...
  window.location.href = `/categories/football/${subcategorySlug}`
}
</script>
