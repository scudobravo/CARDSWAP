...
class DisneyFilterController extends Controller
{
    /**
     * Get all available filter options for Disney cards
     */
    ...
    public function getFilteredProducts(Request $request)
    {
        ...
        $transformedListings = $listings->getCollection()->map(function($listing) {
            ...
            // Es: "Caterpillar - TOPPS DISNEY WONDER (Orange Foil)" -> "Caterpillar"
